...
One of the highest-impact changes: having Claude Code automatically create well-structured PRs from feature branches.
      ...
      - name: Generate PR description with Claude
        ...
        with:
          prompt: |
            ...
            4. Screenshot/recording requirements
